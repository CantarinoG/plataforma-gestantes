...
public class RelatorioController {
    ...
    public void cadastrar(LocalDateTime dataEmissao, Procedimento procedimento, String resultado, String observacoes, LocalDateTime deletadoEm){
        Relatorio novoRelatorio = validator.validaCamposEntrada(resultado, observacoes);
        novoRelatorio.setResultado(resultado);
        novoRelatorio.setObeservacoes(observacoes);
        novoRelatorio.setProcedimento(procedimento);
        repositorio.save(novoRelatorio);
    }
    public void atualizar(int id,LocalDateTime dataEmissao, Procedimento procedimento, String resultado, String observacoes, LocalDateTime deletadoEm){
        Relatorio novoRelatorio = validator.validaCamposEntrada(resultado, observacoes);

...
public class PagamentoController {
    ...
    public void cadastrar(String valor, Usuario registradoPor, Gestante paciente, String status, String metodoPagamento, String deletadoEm){
    ...
    public void atualizar(int id,String valor, Usuario registradoPor, Gestante paciente, String status, String metodoPagamento, String deletadoEm){
        Pagamento novoPagamento = validator.validaCamposEntrada(valor, status, metodoPagamento);
